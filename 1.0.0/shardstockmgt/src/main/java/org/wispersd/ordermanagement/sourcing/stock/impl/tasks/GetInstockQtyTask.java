 ...
 *
 */
public class GetInstockQtyTask extends AbstractParallelStockCallable<LocationProducts, GetQuantityResponse>
{
	public GetInstockQtyTask(final TaskExecutionStrategy taskExecutionStrategy, final JedisCommands jedis,
	...
	{
		return new GetInstockQtyTask(taskExecutionStrategy, nextShard, subReq, redisStockOperationTemplate, splittableBySize,
				maxSize);
	}
	...
	{
		return redisStockOperationTemplate.getInstockQuantities((Jedis) jedis, originalReq);
	}
