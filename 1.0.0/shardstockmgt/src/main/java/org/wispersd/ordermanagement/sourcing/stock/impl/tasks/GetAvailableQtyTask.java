 ...
 *
 */
public class GetAvailableQtyTask extends AbstractParallelStockCallable<LocationProducts, GetQuantityResponse>
{
	public GetAvailableQtyTask(final TaskExecutionStrategy taskExecutionStrategy, final JedisCommands jedis,
	...
	{
		return new GetAvailableQtyTask(taskExecutionStrategy, nextShard, subReq, redisStockOperationTemplate, splittableBySize,
				maxSize);
	}
	...
	{
		return redisStockOperationTemplate.getAvailableQuantities((Jedis) jedis, originalReq);
	}
